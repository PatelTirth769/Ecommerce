...
export class CheckoutComponent implements OnInit{
  ...
  getTotal(){
    this.cartService.totalAmount.subscribe(data=>this.total=Number(data.toFixed(2)));
    this.cartService.gstAmount.subscribe(data=>this.gstAmount=Number(data.toFixed(2)));
    this.cartService.shippingAmount.subscribe(data=>this.shippingCost=Number(data.toFixed(2)));
    this.cartService.discountAmount.subscribe(data=>this.discountAmount=Number(data.toFixed(2)));
    this.cartService.estimatedTotal.subscribe(data=>this.grandTotal=Number(data.toFixed(2)));
  }
